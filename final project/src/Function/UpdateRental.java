	...
	public UpdateRental(JFrame frame) {
		...
		contentPanel.setLayout(null);
		{
			...
			try {
			    ...
			    String s = "SELECT r.rentalId, c.customerId, c.customerName, d.dvdId, d.dvdName FROM rental r, customer c, dvds d WHERE c.customerId = r.customerId AND d.dvdId = r.dvdId AND completedStatus='0'";
		...
		}
		{
			...
			chckbxCompleted.setBounds(207, 72, 97, 23);
		...
		}
		{
			...
			button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try{
			             theQuery("UPDATE rental SET completedStatus = '"+completed+"', dateCompleted='"+strDate+"' WHERE rentalId = '"+ID+"'; ");
			         }
			         catch(Exception ex){}
				dispose();
				}
